...
int feastCardEffect(int currentPlayer, struct gameState *state, int choice1) {
...
int remodelCardEffect(int currentPlayer, struct gameState *state, int choice1, int choice2, int handPos) {
	...
	j = choice2;  //store card we will trash
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
	...
	switch( card ) 
	{
		...
		case council_room:
			return councilRoomCardEffect(currentPlayer, state, handPos);

		case feast:
			return feastCardEffect(currentPlayer, state, choice1);	
		...
		case remodel:
			return remodelCardEffect(currentPlayer, state, choice1, choice2, handPos);	
